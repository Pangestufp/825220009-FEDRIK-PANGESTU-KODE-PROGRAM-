...
class KelolaKategoriView extends GetView<KategoriController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          Container(
            ...
            child: Padding(
              ...
              child: TextField(
                ...
                decoration: Styles.roundedInput("Cari Kategori"),
                onChanged: (value) => controller.searchKategori(value),
              ),
            ),
          ),
          SizedBox(height: 10,),
            ...
            child: Obx(() {
              ...
              return ListView.separated(
                ...
                itemBuilder: (context, index) {
                  final kategori = controller.filteredList[index];
                  return ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () {
                        ...
                        controller.selecteddetail.value=kategori['id_kategori'];
                        Get.toNamed(Routes.KELOLA_DETAIL_KATEGORI);
                      },
                    ),
                  );
                },
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Get.toNamed(Routes.KELOLA_MENAMBAHKAN_KATEGORI);
        },
      ),
    );
  }
