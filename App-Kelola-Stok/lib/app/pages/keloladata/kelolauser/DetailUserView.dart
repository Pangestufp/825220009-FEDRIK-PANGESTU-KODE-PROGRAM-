...
class DetailUserView extends GetView<PenggunaController> {
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        IconButton(
                          onPressed: () {
                            Get.toNamed(Routes.KELOLA_EDIT_USER, arguments: user);
                          },
