...
class KelolaBarangView extends GetView<BarangController> {
  const KelolaBarangView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  return ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () {
                        ...
                        controller.selecteddetail.value=barang['id_barang'];
                        Get.toNamed(Routes.KELOLA_DETAIL_BARANG);
                      },
                    ),
                  );
                },
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Get.toNamed(Routes.KELOLA_MENAMBAHKAN_BARANG);
        },
      ),
    );
  }
