...
class KelolaSatuanView extends GetView<SatuanController> {
  const KelolaSatuanView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: Styles.bar("KELOLA SATUAN"),
      body: Column(
        children: [
          Container(
            ...
            child: Padding(
              ...
              child: TextField(
                ...
                decoration: Styles.roundedInput("Cari Satuan"),
                onChanged: (value) => controller.searchSatuan(value),
              ),
            ),
          ),
          SizedBox(height: 10,),
            ...
            child: Obx(() {
              ...
              return ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    leading: Icon(Icons.scale,color: Styles.primaryColor, size: 50,),
                    title: Text(brand['namasatuan'] ?? '-'),
                    trailing: IconButton(
                      icon: const Icon(Icons.open_in_new_rounded, color: Styles.primaryColor),
                      onPressed: () {
                        controller.selecteddetail.value=0;
                        controller.selecteddetail.value=brand['id_satuan'];
                        Get.toNamed(Routes.KELOLA_DETAIL_SATUAN);
                      },
                    ),
                  );
                },
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Get.toNamed(Routes.KELOLA_MENAMBAHKAN_SATUAN);
        },
      ),
    );
  }
