...
class DetailPerusahaanView extends GetView<PerusahaanController> {
  const DetailPerusahaanView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      controller.fetchPerusahaanById(id);
    });
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final perusahaan = controller.perusahaanDetail.value;
        if (perusahaan == null) {
                  ...
                  children: [
                                ...
                                return AlertDialog(
                                  ...
                                  actions: <Widget>[
                                    ...
                                    TextButton(
                                      onPressed: () {
                                        Navigator.of(context).pop();
                                        controller.deletePerusahaan(id);
                                      },
                                      child: Text("Hapus"),
                                    ),
                                  ],
                    ...
                    Column(
                      children: [
                        IconButton(
                          onPressed: () {
                            Get.toNamed(Routes.KELOLA_EDIT_PERUSAHAAN, arguments: perusahaan);
                          },
