...
class KelolaPesananMitraAction extends GetView<PesananController> {
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      controller.fetchPesananDetailById();
      controller.fetchpesananById();
    });
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final header = controller.pesananDetail.value;
                ...
                Expanded(
                  child: _buildMainActionButton(
                    ...
                    onConfirm: () {
                      ...
                      if(header!=null){
                        if(header['statuspesanan']=="draft"){
                          Get.toNamed(Routes.KELOLA_PESANAN_REVIEW, arguments: controller.detailBarangKeluarList);
                        }else{

                          Get.snackbar(
                            "Error",
                            "Pesanan ini tidak bisa diubah lagi",
